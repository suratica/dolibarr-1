...
if (getDolGlobalString("MAIN_INFO_PROPAL_TERMSOFSALE")) {
	...
	if (file_exists($conf->propal->dir_output.'/'.$termofsale)) {
		print '<div class="inline-block valignmiddle marginrightonly"><a href="'.$documenturl.'?modulepart='.$modulepart.'&amp;file='.urlencode($termofsale).'">'.$termofsale.'</a>'.$formfile->showPreview($termofsale, $modulepart, $termofsale, 0, '');
