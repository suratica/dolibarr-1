...
$output_arrtd = array();
if ($dirphpstan != 'disabled') {
	$commandcheck = ($dirphpstan ? $dirphpstan.'/' : '').'phpstan --level='.$PHPSTANLEVEL.' -v analyze -a dev/build/phpstan/bootstrap.php --memory-limit 16G --error-format=github -c ~/preview.dolibarr.org/dolibarr/phpstan_apstats.neon';
